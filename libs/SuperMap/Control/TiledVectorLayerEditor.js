...
SuperMap.Control.TiledVectorLayerEditor=SuperMap.Class(SuperMap.Control,{
    ...
    initialize:function(option){
        ...
        this._drag=SuperMap.Function.bind(this.handleShowHideBtnDrag,this);
        this._drop=SuperMap.Function.bind(this.handleShowHideBtnDrop,this);
    },
    ...
    saveState:function(){
        ...
        json.autoHide=SuperMap.Control.TiledVectorLayerEditor.hasClass(this.showHideBtn,"move");
    ...
    initEditorViewer:function(){
        ...
        var showHideBtn=this.showHideBtn=this.createEditorShowHideBtn();
        var closeBtn=this.closeBtn=this.createEditorCloseBtn();
        ...
        this.div.appendChild(showHideBtn);
     ...
     * 处理位置控制按钮的鼠标按下事件
     * */
    handleShowHideBtnMouseDown:function(event){
        if(this.active){
            event=event||window.event;
     ...
     * 处理位置控制按钮的拖动事件
     * */
    handleShowHideBtnDrag: function (event) {
        if(this.active){
            event=event||window.event;
            event.preventDefault();
            event.stopPropagation();
            ...
            this.position.x=x;
            this.position.y=y;
            if(element!==this.showHideBtn){
                this.setMainPanelPostionByDirection(this._direction,true);
            }
            this._dragging=true;
        }
    },
     ...
     *
     * */
    handleShowHideBtnDrop: function (event) {
        if(this.active){
            event=event||window.event;
            event.preventDefault();
            event.stopPropagation();
    ...
    createEditorCloseBtn:function(){
        ...
        editorCloseBtn.setAttribute("class","smCloseBtn-container");
    ...
    createMainPanel:function(){
        ...
        SuperMap.Event.observe(mainPanelHeader,"mousedown",SuperMap.Function.bind(this.handleShowHideBtnMouseDown,this));
