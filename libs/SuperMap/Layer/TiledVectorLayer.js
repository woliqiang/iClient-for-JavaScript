    ...
    * */
    ...
    moveTo: function(bounds, zoomChanged, dragging) {
        ...
        if ( ratio&&ratio!==1&&!this.map.isIEMultipTouch&&SuperMap.Browser.device==="pc") {
            transform="translate("+(this.lastChangDx||0)+"px,"+(this.lastChangDy||0)+"px)";
     ...
     *
     */
    highlightFeatures: function (featureInfoes) {
        if(!this.hightlightFeatureInfoes)this.hightlightFeatureInfoes={};
        this.hightlightFeatureInfoes = Array.isArray(featureInfoes)?featureInfoes:[featureInfoes];
        this.refresh();
    },
    ...
    unHightlightFeatures:function(){
        if(this.hightlightFeatureInfoes){
            this.hightlightFeatureInfoes=null;
        }
        this.refresh();
    },
